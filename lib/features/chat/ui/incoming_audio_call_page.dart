...
class _AudioCallPageState extends State<AudioCallPage> {
  ...
  // Сырые статусы от сервиса (на англ.). Отображение — через _statusText.
  String _statusRaw = 'Connecting';
  ...
  // Маппинг входящих "сырых" строк статуса в локализованный текст.
  String get _statusText {
    switch (_statusRaw) {
      ...
      case 'Answered on another device':
        return loc.answeredelsewhere;
      default:
        return _statusRaw; // фолбэк, если пришёл неизвестный статус
    }
  }

  void _updateStatus(String status) {
    // Логика таймера/завершения — по "сырым" строкам, как раньше
  ...
  Widget build(BuildContext context) {
    // Используем прозрачный фон, как было
    return Scaffold(
