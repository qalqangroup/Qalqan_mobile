...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  void _recheck(String pw) {
    ...
    Color color;
    if (score <= 1) {
      label = loc.pwStrengthWeak;
      color = Colors.red;
    } else if (score == 2) {
      label = loc.pwStrengthFair;
      color = Colors.orange;
    } else if (score == 3) {
      label = loc.pwStrengthGood;
      color = Colors.amber[800]!;
    } else {
      label = loc.pwStrengthStrong;
      color = Colors.green;
    }
  ...
  Future<void> _submit() async {
    ...
    if (oldP.isEmpty || n1.isEmpty || n2.isEmpty) {
      setState(() => _error = loc.fillAllFields);
      return;
    }
    if (n1 != n2) {
    ...
    if (!_meetsBaseline()) {
      setState(() => _error = loc.pwMustMeetRequirements);
      return;
    }
    ...
    if (ok) {
      ...
      setState(() => _error = loc.failedToChangePassword);
    }
  }
                  ...
                  child: BackdropFilter(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Icon(Icons.lock_reset, size: 48, color: Color(0xFF5869E5)),
                          ...
                          TextField(
                            ...
                            decoration: _dec(loc.currentPassword, icon: Icons.lock_outline).copyWith(
                          ...
                          TextField(
                            ...
                            onChanged: _recheck,
                            decoration: _dec(loc.newPassword, icon: Icons.lock).copyWith(
                              suffixIcon: IconButton(
                          ...
                          TextField(
                            ...
                            decoration: _dec(loc.repeatNewPassword, icon: Icons.lock).copyWith(
                              suffixIcon: IconButton(
                          ...
                          if (_new2.text.isNotEmpty && _new2.text != _new1.text) ...[
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(child: Text(loc.passwordsDoNotMatch, style: const TextStyle(color: Colors.orange))),
                              ],
                            ),
                          ],
                          ...
                          const SizedBox(height: 8),
                          _reqItem(loc.pwAtLeastNChars(_minLen), _rLen),
                          _reqItem(loc.pwUpperLower, _rCase),
                          _reqItem(loc.pwAtLeastOneNumber, _rDigit),
                          _reqItem(loc.pwAtLeastOneSpecial, _rSpecial),
                          ...
                          SwitchListTile.adaptive(
                            ...
                            title: Text(loc.logoutOtherDevices),
                            ...
                            child: ElevatedButton(
                              ...
                              child: _busy
                                ...
                                child: CircularProgressIndicator(strokeWidth: 2, valueColor: AlwaysStoppedAnimation(Colors.white)),
                                  ...
                                  : Text(loc.save, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                            ),
                          ),
                        ],
                      ),
